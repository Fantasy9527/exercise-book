define(["angular", "uiRouter"], function () {
  ...
  app.config(function ($stateProvider, $urlRouterProvider) {
    ...
    $stateProvider
      .state('home', {
        url: '/home',
        templateUrl: '/assets/templates/shop/goodsTypePrint.html',
        controller: 'goodsTypePrintController'
      })
  })

  app.controller("goodsTypePrintController", ["$scope", "$http", "$location", function ($scope, $http, $location) {
    $scope.isLoding = true;
    var params;
