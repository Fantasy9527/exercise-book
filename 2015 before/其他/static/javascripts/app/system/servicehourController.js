define(["systemApp","ractivePackage"], function(app) {
  app.controller("servicehourController", ["$rootScope", "$scope", "$http", "$location", "$timeout",
    function($rootScope, $scope, $http, $location, $timeout) {
      ...
      function init(models) {
        ...
        ractive.on("saveModel", function(event) {
          ...
          var self = this
          Post("/home/brand/"+brandId+"/servicehour", model).done(function(data) {
        ...
        ractive.on("updateModel", function(event, id) {
          ...
          Post("/home/brand/"+brandId+"/servicehour/" + id, model).done(function(data) {
        ...
        ractive.on("removeModel", function(event) {
          ...
          var url = "/home/brand/"+brandId+"/servicehour/" + editing
