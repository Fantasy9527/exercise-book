define(["systemApp","datetimepicker"], function(app) {
  app.controller("goodsApplyController", ["$scope", "$http", "$location", "$timeout", "$document","$state", function ($scope, $http, $location, $timeout, $document,$state) {
    ...
    function getModels(province, city){
      ...
      var url = "/home/brand/" + brandId + "/goodsType/" + $state.params.goodsTypeId + "/apply/shop"
    ...
    $scope.deleteData = function(shop){
      var url = '/home/brand/' + brandId + '/goodsType/' + $state.params.goodsTypeId + '/apply/shop/' + shop
    ...
    $scope.batchSave = function(){
      var url = "/home/brand/" + brandId + "/goodsType/" + $state.params.goodsTypeId + "/apply/shop/batch"
