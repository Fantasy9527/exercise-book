define(["systemApp","datetimepicker"], function(app) {
  app.controller("setPriceController", ["$scope", "$http", "$location", "$timeout", "$document","$state", function ($scope, $http, $location, $timeout, $document,$state) {
    $scope.paramGoods=$state.params.set;
    setTimeout(function () {
