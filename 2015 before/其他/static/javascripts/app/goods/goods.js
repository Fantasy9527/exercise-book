define(["angular", "uiRouter", "angularFileUpload"], function() {
  ...
  app.controller("goodsController", ["$scope", "$http", "$location", "FileUploader", function($scope, $http, $location, FileUploader) {
    var params;
    $(".goodsMain").css({
      "visibility": "visible"
    })
    ...
    $scope.goSet = function(e, obj) {
        e.stopPropagation()
        location.href = "/home/brand/" + brandId + "/goodsType/" + obj + "/detail#?group=" + params.group + "&subgroup=" + params.subgroup + "&page=" + params.page + "&pageSize=" + params.pageSize
      }
      //*****************************
      //批量设置
