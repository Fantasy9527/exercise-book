define(["angular", "uiRouter", "angularFileUpload"], function () {
  ...
  app.controller("goodsTypeDetailController", ["$scope", "$http", "$location", "$timeout", "$document", "FileUploader", function ($scope, $http, $location, $timeout, $document, FileUploader) {

    $scope.superParams = $location.search()

    function getModel(){
      var url = "/home/brand/" + brandId + "/goodsType/" + goodsTypeId + "/detail/get"
    ...
    $scope.addGoods = function(){
      $scope.isSaving = true
      var url = "/home/brand/" + brandId + "/goodsType/" + goodsTypeId + "/goods/add"
    ...
    $scope.saveGoodsType = function(){
      var url = "/home/brand/" + brandId + "/goodsType/" + goodsTypeId + "/base/update"
      var postModel = {}
      ...
      $http.post(url, postModel).success(function(data){
        location.replace('/home/brand/' + brandId + '/goodsType/' + goodsTypeId +  '/detail')
      }).error(function(data){
        alert(data.message)
      })
    }
    ...
    $scope.deleteGoodsType = function(model){
      var url = '/home/brand/' + brandId + '/goodsType/' + goodsTypeId + '/remove'
      $http.delete(url).success(function(){
